...
*   **Missing Skills:** Discover critical skills that are typically expected in your field but are missing from your resume.
...
*   **Dark Mode:** A sleek dark theme that respects your system preferences.
...
3. Add your `VITE_GEMINI_API_KEY` to the Environment Variables in your hosting provider's dashboard.
